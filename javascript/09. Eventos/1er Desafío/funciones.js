...
function confirmacionPedido (confirmaPedido){
	...
	if(b ==1){
		...
		document.getElementById("prespuesto").setAttribute("style","display:none");
		const eliminarElemento = document.getElementsByClassName("modal-backdrop fade show");
		eliminarElemento.parentElement.removeChild(eliminarElemento);
